...
public class PhraseOMatic {
	...
	public static void main(String[] args) {
		...
		String[] wordListTwo = {"empowered", "sticky", "value-added", "oriented",
				"centric", "distirbuted", "clustered", "branded", "outside-the-box",
				"positioned", "networked", "focused", "leveraged", "aligned", "targeted",
				"shared", "cooperative", "accelerated"}; 
		
		String[] wordListThree = {"process", "tipping-point", "solution", "architecutre",
				"core competency", "strategy", "mindshare", "portal", "space", "visions", 
				"paradigm", "mission"};
